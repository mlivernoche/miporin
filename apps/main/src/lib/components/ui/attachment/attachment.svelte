<script lang="ts" module>
	...
	export const attachmentVariants = tv({
		base: "w-fit rounded-3xl focus-within:ring-1 focus-within:ring-ring/30 group/attachment relative flex max-w-full min-w-0 shrink-0 flex-wrap border bg-card text-card-foreground transition-colors has-[>a,>button]:hover:bg-muted/50 data-[state=error]:border-destructive/30 data-[state=idle]:border-dashed",
		variants: {
			size: {
